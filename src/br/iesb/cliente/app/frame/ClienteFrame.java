...
public class ClienteFrame extends JFrame {
	...
	private void initialize() {
		...
		getContentPane().setLayout(
				new MigLayout("", "[][fill][][16.00][grow][40][20][20][20][40][0.01][50][][][50]",
						"[20][][][20.00][grow][][][15][15][15][15]"));
		...
		txtAreaReceive.setBorder(new TitledBorder(null, "Chat", TitledBorder.LEADING, TitledBorder.TOP, null,
				Color.LIGHT_GRAY));
		...
		txtAreaSend.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Mensagem",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(192, 192, 192)));
		...
		mntmInformaesDaRede.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "IP do Servidor: " + socket.getInetAddress().toString()
						+ "\nIP do cliente: " + socket.getLocalAddress().toString(), "Informações da rede",
